...
<div class="container w-md-75 my-4">
    <div class="card rounded border-0 shadow px-4 py-2 mx-3 my-2" style="border-radius: 0.5rem">
        <h2 class="text-primary text-center font-weight-bold mt-2 mb-0">
            Privacy Policy for Dumask.id<sup>&reg;</sup>
        </h2>
        <hr class="my-2">
        <div class="text-secondary text-justify mt-4 mx-auto">
            <div id="md_en" data-target="out_en" class="agreement_md">
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to dumask.id<sup>&reg;</sup>, accessible from <a href="https://dumask.id"
                ...
                <ul>
                    ...
                    <li><strong>Flash Cookies.</strong> Certain features of our Service may use local stored objects (or Flash
                        ...
                        on how You can delete Flash Cookies, please read "Where can I change the settings for disabling, or deleting
                ...
                <ul>
                    <li>By email: dumask.id.app@gmail.com</li>
                </ul>
            </div>
        </div>
    </div>
